...
/*
	SZ Marker
*/
acd_SZ_NORTH_EAST_Molos_marker = createMarker ["North_east_TraderCityMarker", [26845,24697.6,0.000989914]];
"North_east_TraderCityMarker" setMarkerShape "ELLIPSE";
"North_east_TraderCityMarker" setMarkerSize [200,200];
"North_east_TraderCityMarker" setMarkerColor "ColorBlue";
"North_east_TraderCityMarker" setMarkerBrush "SolidBorder";
"North_east_TraderCityMarker" setMarkerAlpha 1;
"North_east_TraderCityMarker" setMarkerText "BmGJ Trader City";
/*
	SZ Sensor
*/
ExileTrader = createTrigger ["EmptyDetector",[26833.49,24850.111,21.780668]];
ExileTrader setTriggerArea [280,300,40,true];
...
*/
acd_SZ_NORTH_EAST_Molos_marker = createMarker ["North_east_TraderCityMarker",[26845,24697.6,0.000989914]];
"North_east_TraderCityMarker" setMarkerShape "ICON";
"North_east_TraderCityMarker" setMarkerType "MinefieldAP";
"North_east_TraderCityMarker" setMarkerSize [0.60000002,0.60000002];
"North_east_TraderCityMarker" setMarkerColor "ColorBlack";
"North_east_TraderCityMarker" setMarkerText "Black market";	
};
