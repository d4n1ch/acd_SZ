/*
	...
	acd_SZ_CENTRAL_Default_traders.sqf
	by d4n1ch
	mailto: d.e@acd.su
*/
if (!acd_SZ_CENTRAL_Default) exitWith {
	diag_log format ["### ACD: SAFE ZONE IS OFF: NO TRADERS WILL SPAWN: acd_SZ_CENTRAL_Default = %1 ###", acd_SZ_CENTRAL_Default];
};
...
if (acd_SZ_CENTRAL_Default_Guards) then {	
	///////////////////////////////////////////////////////////////////////////
	// Guard 01
	///////////////////////////////////////////////////////////////////////////
	[
